...
declare class ReactQuill extends React.Component<ReactQuillProps, ReactQuillState> {
    ...
    */
    ...
    makeUnprivilegedEditor(editor: Quill): {
        ...
        getContents: (index?: number | undefined, length?: number | undefined) => Delta;
        getSelection: {
    ...
    render(): JSX.Element;
    onEditorChange: (eventName: "text-change" | "selection-change", rangeOrDelta: Delta | RangeStatic | null, oldRangeOrDelta: Delta | RangeStatic | null, source: Sources) => void;
    onEditorChangeText(value: string, delta: Delta, source: Sources, editor: UnprivilegedEditor): void;
